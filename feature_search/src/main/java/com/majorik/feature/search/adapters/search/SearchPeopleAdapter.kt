...
import com.majorik.feature.search.presentation.viewholders.SearchPeopleSmallVH
import com.majorik.feature.search.presentation.viewholders.SearchPeopleViewHolder
                ...
                holder.itemView.setSafeOnClickListener {
                    getItem(position)?.let { item ->
                        holder.itemView.context.startDetailsActivityWithId(
                            item.id,
                            "com.majorik.feature.details.presentation.person_details.PersonDetailsActivity"
                        )
                    }
                }
            }
