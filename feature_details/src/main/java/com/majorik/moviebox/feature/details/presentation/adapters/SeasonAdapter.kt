...
import com.majorik.moviebox.feature.details.presentation.adapters.SeasonAdapter.SeasonViewHolder
import com.majorik.moviebox.feature.details.seasonDetails.SeasonDetailsActivity
import com.majorik.library.base.constants.UrlConstants
import com.majorik.library.base.extensions.displayImageWithCenterCrop
import com.majorik.library.base.extensions.setSafeOnClickListener
import kotlinx.android.synthetic.main.item_season_card_details.view.*
...
class SeasonAdapter(private val tvId: Int, private val seasons: List<TVDetails.Season>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SeasonViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.majorik.moviebox.feature.details.R.layout.item_season_card_details, parent, false)
