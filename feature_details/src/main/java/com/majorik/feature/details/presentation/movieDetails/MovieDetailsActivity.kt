package com.majorik.feature.details.presentation.movieDetails
...
class MovieDetailsActivity : BaseSlidingActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.majorik.feature.details.R.layout.activity_movie_details)
...
//         externalCacheDirs?.forEach { it.deleteRecursively() }
    ...
    private fun setClickListenerForImages(
        ...
        m_backdrop_image.setOnClickListener {
            StfalconImageViewer.Builder(this, images.backdrops.map { it.filePath }) { view, image ->
                ...
                }.withOverlayView(layoutInflater.inflate(com.majorik.feature.details.R.layout.item_genre_inline, null))
    ...
    private fun setObserver() {
        movieDetailsViewModel.movieDetailsLiveData.observe(this, Observer { movie ->
            ...
            m_release_date.text =
                KlockLocale.russian.formatDateLong.format(movie.releaseDate.toDate(getString(com.majorik.feature.details.R.string.yyyy_mm_dd)))
            ...
            m_add_info.text = getString(
                com.majorik.feature.details.R.string.short_info_mask,
                movie.releaseDate.toDate(getString(com.majorik.feature.details.R.string.yyyy_mm_dd)).yearInt.toString(),
                genres
            )
    ...
    private fun setReleaseDate(runtime: Int?) {
        if (runtime != null) {
            ...
            val stringHours = resources.getQuantityString(com.majorik.feature.details.R.plurals.hours, hours, hours)

            val minutes = runtime % 60
            val stringMinutes = resources.getQuantityString(com.majorik.feature.details.R.plurals.minutes, minutes, minutes)

            m_runtime.text = getString(com.majorik.feature.details.R.string.runtime_mask, stringHours, stringMinutes)
        } else {
            m_runtime.text = getString(com.majorik.feature.details.R.string.unknown)
        }
    }
