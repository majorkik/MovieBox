package com.majorik.feature.details.seasonDetails

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.lifecycle.Observer
import com.majorik.feature.details.presentation.adapters.EpisodeAdapter
...
class SeasonDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.majorik.feature.details.R.layout.activity_season_details)
