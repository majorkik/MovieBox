...
import com.majorik.feature.details.presentation.adapters.GenresInlineAdapter.*
...
class GenresInlineAdapter(private val genres: List<Genre>) :
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(com.majorik.feature.details.R.layout.item_genre_inline, parent, false)
