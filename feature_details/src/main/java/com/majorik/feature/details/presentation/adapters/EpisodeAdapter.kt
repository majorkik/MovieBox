...
import com.majorik.feature.details.domain.tmdbModels.tv.Episode
import com.majorik.feature.details.presentation.adapters.EpisodeAdapter.EpisodeViewHolder
...
class EpisodeAdapter(private val episodes: List<Episode>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EpisodeViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.majorik.feature.details.R.layout.item_episode_card, parent, false)
