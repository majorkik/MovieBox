...
object GenresConstants {
    data class Genre(val id: Int, val name: String, val image: String)
...
//            Genre(10751, "Семейный"),
        Genre(10759, "Боевик и Приключения", "/87eP7ITTrOWvkA4EqCuoRdyjzLy.jpg"),
        Genre(10762, "Детский", "/ugaNgBYPLBQwYtE7A1WSdLfPEZ4.jpg"),
        Genre(10763, "Новости", "/tJTFyHmM3sHFoF2Ik5PncUwBmlO.jpg"),
        Genre(10764, "Реалити-шоу", "/iILlo44LlZ3wjYNB02hkb5SgoYi.jpg"),
        Genre(10765, "НФ и фэнтези", "/56v2KjBlU4XaOv9rVYEQypROD7P.jpg"),
        Genre(10766, "Мыльная опера", "/i75aWzwR06cCUwOTzS8zSWg8th8.jpg"),
        Genre(10767, "Ток-шоу", "/sVSepFJ2ymjFwY4Q0qmVF925PvK.jpg"),
        Genre(10768, "Война и политика", "/8UVzqlBMG3azowsi7f8lqZwhcBZ.jpg")
    )
}
