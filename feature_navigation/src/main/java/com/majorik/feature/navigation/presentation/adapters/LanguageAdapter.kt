...
import com.majorik.feature.navigation.R
import com.majorik.feature.navigation.presentation.adapters.LanguageAdapter.LanguageViewHolder
...
class LanguageAdapter(private val listener: (locale: Locale) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LanguageViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(com.majorik.feature.navigation.R.layout.item_lanugage, parent, false)
