...
import com.majorik.feature.navigation.domain.movie.MovieCollectionType
import com.majorik.feature.navigation.domain.movie.MovieCollectionType.*
import com.majorik.feature.navigation.presentation.adapters.*
...
import com.majorik.feature.navigation.presentation.adapters.MovieTrendAdapter
...
class MoviesFragment : BaseNavigationFragment() {
    ...
    override fun getLayoutId() = com.majorik.feature.navigation.R.layout.fragment_movies
    ...
    private fun setClickListeners() {
        btn_search.setOnClickListener {
            context?.startActivityWithAnim("com.majorik.feature.search.presentation.search.SearchableActivity")
        }

        btn_popular_movies.setOnClickListener {
            openNewActivityWithTab(
                "com.majorik.feature.collections.movieTabCollections.MovieCollectionsActivity",
                POPULAR
            )
        }
        ...
        btn_movie_genres.setSafeOnClickListener {
            val intent =
                Intent().setClassName(requireContext(), "com.majorik.feature.collections.genres.GenresActivity")
