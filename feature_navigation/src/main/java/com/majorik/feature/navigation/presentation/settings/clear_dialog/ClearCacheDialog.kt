...
class ClearCacheDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(com.majorik.feature.navigation.R.layout.dialog_clear_cache, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cache_size.text = getString(R.string.cache_size_with_format, cacheSize)
