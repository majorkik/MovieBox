package com.majorik.feature.navigation.presentation.main_page_tvs
...
import com.majorik.feature.navigation.domain.movie.TVCollectionType
...
class TVsFragment : BaseNavigationFragment() {
    ...
    override fun getLayoutId() = com.majorik.feature.navigation.R.layout.fragment_tvs
    ...
    private fun setClickListeners() {
        btn_search.setOnClickListener {
            startActivity(
                Intent().setClassName(
                    requireContext(),
                    " com.majorik.feature.search.presentation.search.SearchableActivity"
                )
            )
        }
        ...
        btn_popular_tvs.setSafeOnClickListener {
            openNewActivityWithTab(
                "com.majorik.feature.collections.tvTabCollections.TVCollectionsActivity",
