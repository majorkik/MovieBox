...
import com.majorik.feature.collections.domain.tmdbModels.cast.Cast
import com.majorik.library.base.constants.UrlConstants
import com.majorik.moviebox.R
import com.majorik.feature.collections.presentation.adapters.CastAdapter.CastViewHolder
...
class CastAdapter(private val people: List<Cast>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CastViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.majorik.feature.collections.R.layout.item_cast_profile_card, parent, false)
