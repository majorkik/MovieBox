package com.majorik.feature.collections.tvTabCollections
...
import com.majorik.feature.collections.R
import com.majorik.feature.collections.domain.movie.TVCollectionType
import com.majorik.feature.collections.presentation.adapters.FragmentsPagerAdapter
...
class TVCollectionsActivity : BaseSlidingActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.majorik.feature.collections.R.layout.activity_tab_collections)
        ...
        m_toolbar_collections.navigationIcon?.setTint(
            ContextCompat.getColor(
                this,
                com.majorik.base.R.color.mine_shaft
            )
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.navigationBarColor = ContextCompat.getColor(this, com.majorik.base.R.color.mine_shaft)
        }
