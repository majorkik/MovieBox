...
import com.majorik.feature.collections.presentation.adapters.CompaniesAdapter.*
...
class CompaniesAdapter(private val companies: List<ProductionCompany>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CompanyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.majorik.feature.collections.R.layout.item_company, parent, false)
